              ...
              <div>
                ...
                <div className="mt-4 pt-3 border-t border-slate-200">
                  ...
                  {(() => {
                    ...
                    return (
                      <div className={`flex items-center justify-between rounded-lg px-3 py-2 mb-2 ${pending > 0 ? 'bg-amber-50 border border-amber-200' : 'bg-emerald-50 border border-emerald-200'}`}>
                        <div>
